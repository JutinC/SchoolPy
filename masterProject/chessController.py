...
class ChessController:
    ...
    def __init__(self):
        ...
        self.playerFrame = tk.Frame(self.mainWin, width = 750, height = 1000)
        self.playerFrame.grid(row = 0, column = 0)
        
        # Set the game Frame
        self.gameFrame = tk.Frame(self.mainWin, width = 750, height = 1000)
        ...
        #Player Image   
        self.chessImage = tk.PhotoImage(file='/Users/imatable/SchoolPy/playerimg.jpg')
        self.canvas = tk.Canvas(self.playerFrame, width=800, height=1000)
        self.canvas.place(x= 0,y=  0)
        self.canvas.create_image(0, 0, image=self.chessImage, anchor="nw")
        
        #Game Image
        self.gameImage = tk.PhotoImage(file = '/Users/imatable/SchoolPy/gameimg.jpg')
        self.canvas = tk.Canvas(self.gameFrame, width = 750, height= 1000)
        self.canvas.place(x=0, y = 0)
        self.canvas.create_image(0, 0, image = self.gameImage, anchor = "nw")
        ...
        #Age
        self.lblAge.place(x=375, y=110)
        self.entryAge.place(x=375, y=130)
        
        #Country
        self.lblCountry.place(x=525, y=110)
        self.entryCountry.place(x=525, y=130)
        
        #Ratings
        self.lblBlitzRating.place(x=150, y=240)
        self.entryBlitzRating.place(x=150, y=260)

        self.lblBlitzRank.place(x=450, y=240)
        self.entryBlitzRank.place(x=450, y=260)
   
        self.lblRapidRating.place(x=150, y=300)
        self.entryRapidRating.place(x=150, y=320)
     
        self.lblRapidRank.place(x=450, y=300)
        self.entryRapidRank.place(x=450, y=320)
        
        self.lblClassicalRating.place(x=150, y=360)
        self.entryClassicalRating.place(x=150, y=380)
     
        self.lblClassicalRank.place(x=450, y=360)
        self.entryClassicalRank.place(x=450, y=380)
        ...
        self.entryId2 = tk.Entry(self.gameFrame, width = 5, bd = 1, relief = "sunken", state = "disabled")
        ...
        self.entrymoveList = tk.Entry(self.gameFrame, width = 69, bd = 1, relief = "sunken")
        ...
        self.entryComments = tk.Entry(self.gameFrame, width = 69, bd = 1, relief = "sunken")
        ...
        #Game button
        self.btnGame.place(x=25, y=40)
        
        #Id
        self.lblId2.place(x=625, y =20)
        self.entryId2.place(x=625, y=40)

        #Player
        self.lblPlayer.place(x=50, y=110)
        self.entryPlayer.place(x=50, y=130)
        
        #moveList
        self.lblmoveList.place(x=50, y=340)
        self.entrymoveList.place(x=50, y=360)
        
        #GameType
        self.lblGameType.place(x=50, y=240)
        self.entryGameType.place(x=50, y=260)
        
        #Ratings
        self.lblResult.place(x=400, y=240)
        self.entryResult.place(x=400, y=260)
        
        self.lblComments.place(x=50, y=400)
        self.entryComments.place(x=50, y=420)
        ...
        #FeedBack Label
        self.lblFeedback2.place(x=25, y=750)
...
#GAME Navigation Section
    ...
    def addPlayer(self):
        if(not self.midInsert):
            ...
            #pgets the player data
            self.getPlayer()         
            #calls insert function
            answer = self.playerDB.create_player()       
            self.lblFeedback.config(text = answer)
            self.btnNew.config(text = "New Player")
            self.midInsert = False
            
    def getPlayer(self):
            #function to ge each entry
    ...
    #CREATE
    def addGame(self):
        #Clears everything to add new record
        if(not self.midInsert2):
            ...
            self.getGame()                   
            answer2 = self.gameDB.create_game()          
    ...
    #Confirmation on how to delete the record for player
    ...
    #Confirmation on how to delete the record for game
    ...
    #Confirmation on how to delete the record for both 
    ...
    #Blanks everything for the game
    def clear2(self):
        self.entryId2.config(state = "normal")
    ...
    def runGame(self):
        #Gets the moveList then runs commands to pull out the game
