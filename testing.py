...
#Game values
        ...
        self.playerFrame = tk.Frame(self.mainWin, width = 750, height = 800)
        self.playerFrame.grid(row = 0, column = 0)
        
        # Set the game Frame
        self.gameFrame = tk.Frame(self.mainWin, width = 750, height = 800)
        ...
        # # #Picture
        # self.bgFrame = tk.Frame(self.mainWin, width=813, height=477)
...
#ADDD BOTH GAMES
        ...
        # self.navMenu.add_command(label = "Player", command = self.playerRec)
        # self.navMenu.add_command(label = "Game", command = self.gameRec)
        ...
        # #Connection Button
        self.connectButton = tk.Button(self.playerFrame, text = "Connect", width = 10, height = 2, bg = "green", fg = "black", command = self.connectionManager)
...
#PLAYER Labels and Entries
        ...
        self.entryName = tk.Entry(self.playerFrame, width = 30, bd = 1, relief = "sunken")

        self.lblAge = tk.Label(self.playerFrame, text = "Age", bg = "azure")
        self.entryAge = tk.Entry(self.playerFrame, width = 30, bd = 1, relief = "sunken")

        self.lblCountry = tk.Label(self.playerFrame, text = "Country", bg = "azure")
        self.entryCountry = tk.Entry(self.playerFrame, width = 30, bd = 1, relief = "sunken")

        self.lblBlitzRating = tk.Label(self.playerFrame, text = "Blitz Rating", bg = "azure")
        self.entryBlitzRating = tk.Entry(self.playerFrame, width = 30, bd = 1, relief = "sunken")
        
        self.lblBlitzRank = tk.Label(self.playerFrame, text = "Blitz Rank", bg = "azure")
        self.entryBlitzRank = tk.Entry(self.playerFrame, width = 30, bd = 1, relief = "sunken")
        
        self.lblRapidRating = tk.Label(self.playerFrame, text = "Rapid Rating", bg = "azure")
        self.entryRapidRating = tk.Entry(self.playerFrame, width = 30, bd = 1, relief = "sunken")
        
        self.lblRapidRank = tk.Label(self.playerFrame, text = "Rapid Rank", bg = "azure")
        self.entryRapidRank = tk.Entry(self.playerFrame, width = 30, bd = 1, relief = "sunken")
        
        self.lblClassicalRating = tk.Label(self.playerFrame, text = "Classical Rating", bg = "azure")
        self.entryClassicalRating = tk.Entry(self.playerFrame, width = 30, bd = 1, relief = "sunken")
        
        self.lblClassicalRank = tk.Label(self.playerFrame, text = "Classical Rank", bg = "azure")
        self.entryClassicalRank = tk.Entry(self.playerFrame, width = 30, bd = 1, relief = "sunken")
...
#GAME Labels and Entries
        self.lblId2 = tk.Label(self.gameFrame, text = "Record Id", bg = "azure")
...
#PLAYER CRUD Section
    ...
    def displayPlayer(self, playerNum):
        ...
        #Clear the entries
        self.clear()
        # print(self.player.id) #Daemon print to show me I am on the correct record (Debugging)
...
#GAME CRUD Section
    ...
    def displayGame(self, GameNum):
        ...
        #Clear the entries
        self.clear2()
        # print(self.game.id) #Daemon print to show me I am on the correct record (Debugging)
...
#Blank out game frame
    ...
    #Creates a new window to edit the values
    def editWin(self):
        #Adds a new window
        newWin = tk.Toplevel(self.mainWin)
        
        #Title
        newWin.title("Edit")
        
        #Sets Geometry
        newWin.geometry('1500x1000')
